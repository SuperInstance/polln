...
import { Cpu, Terminal, Play, ArrowRight, Download, HardDrive, Box, CheckCircle } from "lucide-react";
...
const specs = [
  ...
  { label: "Die Size", value: "25mm²" },
  { label: "Yield", value: "93%" },
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 bg-amber-500/10 border border-amber-500/30 rounded-full px-5 py-2 mb-6">
              ...
              <span className="text-amber-400 text-sm font-medium">For Engineers</span>
            </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 max-w-3xl mx-auto">
            {[
              { value: "~700", label: "Lines of RTL" },
              { value: "MIT", label: "License" },
              { value: "28nm", label: "Target Node" },
              { value: "$99", label: "Target Price" },
            ].map((stat) => (
              <div
                key={stat.label}
                className="bg-dark-800/60 backdrop-blur-sm rounded-xl p-4 border border-dark-600 text-center"
              >
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-3xl sm:text-4xl font-bold mb-6">The RAU: Key Innovation</h2>
              ...
              <div className="space-y-4 mb-8">
                <div className="bg-dark-700/50 rounded-xl p-5 border border-dark-600">
                  <div className="text-sm text-gray-500 mb-2">Traditional MAC</div>
                  <div className="font-mono text-lg">result = activation × weight</div>
                  <div className="text-xs text-gray-500 mt-2">Gates: ~500 per bit | Power: High</div>
                </div>

                <div className="bg-amber-500/10 border border-amber-500/30 rounded-xl p-5">
                  <div className="text-sm text-amber-400 mb-2">TernaryAir RAU</div>
                  <div className="font-mono text-lg">result = activation ⊕ weight</div>
                  <div className="text-xs text-amber-400/70 mt-2">Gates: ~50 total | Power: Low</div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 p-4 bg-green-500/10 border border-green-500/30 rounded-xl">
                ...
                <div className="text-green-400 font-semibold">
                  90% gate reduction | 85% power reduction
                </div>
              </div>
            </div>
            ...
            <div className="code-block">
              ...
              <div className="code-content font-mono text-sm">
                <pre className="text-gray-300">{`// Ternary weights {-1, 0, +1}
always_comb begin
    case (weight)
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400 max-w-2xl mx-auto text-lg">
              Simplified block diagram of the TernaryAir inference engine
            </p>
          </div>
...
│                       [KV Cache] ──▶ USB        │
│                                                  │
│   Process: 28nm │ Power: 3-5W │ Speed: 100MHz  │
└─────────────────────────────────────────────────┘`}</pre>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-dark-800/30">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold mb-4">RTL Modules</h2>
            <p className="text-gray-400 max-w-2xl mx-auto text-lg">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 max-w-5xl mx-auto">
            {rtlModules.map((file) => (
              <div key={file.name} className="bg-dark-800/80 rounded-xl p-5 border border-dark-600 hover:border-amber-500/30 transition-colors">
                <div className="flex items-center justify-between mb-2">
                  <span className="font-mono text-sm text-amber-400">{file.name}</span>
                  <span className="text-xs px-2 py-1 rounded bg-dark-700 text-gray-500">{file.lines} lines</span>
                </div>
                <p className="text-sm text-gray-400">{file.desc}</p>
              </div>
            ))}
          </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold mb-4">Physical Design Specifications</h2>
            <p className="text-gray-400 max-w-2xl mx-auto text-lg">
              Target specifications for silicon implementation
            </p>
          </div>

          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
            {specs.map((spec) => (
              <div key={spec.label} className="bg-dark-800/80 rounded-xl p-5 border border-dark-600 text-center">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-dark-800/30">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold mb-4">Prototyping & Simulation</h2>
            <p className="text-gray-400 max-w-2xl mx-auto text-lg">
              Tools and commands for FPGA prototyping and RTL simulation
            </p>
          </div>
          
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {/* FPGA */}
            <div className="bg-dark-800/80 rounded-2xl p-6 border border-dark-600">
              ...
              <div className="code-block">
                <div className="code-content font-mono text-xs">
                  <pre className="text-gray-300">{`# Build bitstream for PYNQ-Z2
cd hardware/fpga
...
make flash-prebuilt BOARD=pynq-z2`}</pre>
              ...
              <div className="mt-4 flex items-center gap-2 text-sm text-gray-400">
                ...
                Supported: PYNQ-Z2, Arty A7, Zedboard
              </div>
            </div>
            ...
            <div className="bg-dark-800/80 rounded-2xl p-6 border border-dark-600">
              ...
              <div className="code-block">
                <div className="code-content font-mono text-xs">
                  <pre className="text-gray-300">{`# Install Icarus Verilog
...
gtkwave dump.vcd`}</pre>
              ...
              <div className="mt-4 flex items-center gap-2 text-sm text-gray-400">
                <CheckCircle className="w-4 h-4 text-green-400" />
                Also supports: Verilator, VCS, Questa
              </div>
            </div>
          </div>
        </div>
      ...
      {/* CTA */}
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-amber-900/20 to-dark-900">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl font-bold mb-6">Start Building</h2>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link
              href="/download"
              className="flex items-center gap-2 bg-gradient-to-r from-amber-600 to-orange-600 hover:from-amber-500 hover:to-orange-500 text-white px-8 py-4 rounded-xl font-medium transition-all glow-amber shadow-lg"
            >
