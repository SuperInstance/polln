...
import { 
  ...
  Users, Clock, Code, ArrowRight, ExternalLink
} from "lucide-react";
...
const navItems = [
  ...
  { name: "Pro Tools", href: "/professional", icon: Code },
        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <Link href="/" className="flex items-center gap-3 group">
            ...
            <div className="hidden sm:block">
              <span className="text-xl md:text-2xl font-bold gradient-text">TernaryAir</span>
              <p className="text-[10px] text-gray-500 -mt-1">Learn AI Through Play</p>
            </div>
          </Link>
